...
WIDTH = 750
HEIGHT = 600
BACKGROUND = pygame.transform.scale(pygame.image.load('cijevibackground.png'), (WIDTH, HEIGHT))
WIN = pygame.display.set_mode((WIDTH, HEIGHT))
CIJEV1 = pygame.transform.scale(pygame.image.load('cijev1-removebg-preview.png'), (150, 150))
